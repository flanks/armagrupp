...
class Clothing {
    ...
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_NikosBody",              "Chinese Brat",              50000, { "", "", -1 } },			
	...
	class cop {
        ...
        uniforms[] = {
            ...
            { "U_B_CTRG_2", "Nato Uniform", 0, { "", "", -1 } },			

            // Rank 2
            { "U_B_CombatUniform_mcam_worn", "", 0, "call life_coplevel >= 2" },
			{ "U_B_GEN_Soldier_F", "", 0, "call life_coplevel >= 2"},
			{ "U_B_GEN_Commander_F", "", 0, "call life_coplevel >= 2"},
			{ "U_B_survival_uniform", "", 0, "call life_coplevel >= 2"},			
			{ "U_B_CTRG_1", "", 0, "call life_coplevel >= 4"},
			{ "U_B_CTRG_3", "", 0, "call life_coplevel >= 3"},
			{ "U_B_GhillieSuit", "", 0, "call life_coplevel >= 6"},
            { "U_B_Wetsuit", "", 0, "call life_coplevel >= 2" },
			{ "U_B_CombatUniform_mcam", "", 0, "call life_coplevel >= 4" }
        ...
        headgear[] = {
            ...
            // Rank 3
            { "H_Beret_02", "", 0, "call life_coplevel >= 3" },
            { "H_Beret_Colonel", "", 0, "call life_coplevel >= 3" }
        ...
        goggles[] = {
            ...
            { "G_Combat", "", 0, { "", "", -1 } },
            { "G_Aviator", "", 0, { "", "", -1 } },
            { "G_Balaclava_combat", "", 75, "call life_coplevel >= 3" },
            { "G_Diving", "", 0, { "", "", -1 } },
        ...
        vests[] = {
			...
			{ "V_TacVest_oli", "", 0, { "", "", -1 } },		
            { "V_TacVest_blk_POLICE", "", 0, "call life_coplevel >= 1" },
    ...
    class blackmarket {
        ...
        headgear[] = {
            ...
            { "H_Shemag_olive", "", 850, "" },
			{ "H_Shemag_olive_hs", "", 850, "" },
            { "H_MilCap_oucamo", "", 1200, "" },
			{ "H_Booniehat_tna_F", "", 1200, "" },
			{ "H_Milcap_tna_F", "", 1200, "" }			
        };
        ...
        vests[] = {
            ...
            { "V_TacVest_oli",          "",            100000, { "", "", -1 } },
            { "V_TacVest_camo",          "",         100000, { "", "", -1 } },
            { "V_TacVest_blk",          "",            100000, { "", "", -1 } },		
            { "V_TacVest_blk",          "",            100000, { "", "", -1 } },	
			{ "V_PlateCarrierIA1_dgtl", "",          200000, { "", "", -1 } },
			{ "V_TacVestIR_blk",          "",          100000, { "", "", -1 } }
        };
    ...
    class rebel {
        ...
        vests[] = {
			...
			{ "V_TacVest_blk", "", 1250, "" },
			{ "V_TacVest_oli", "", 1250, "" },
			{ "V_I_G_resistanceLeader_F", "", 1250, "" },
            { "V_PlateCarrierL_CTRG", "", 10000, "" }
        };
        backpacks[] = {
       ...
       /* class rebelofficer {
        ...
        conditions = "license_civ_rebelofficer";
        side = "civ";
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
    ...
    conditions = "license_civ_rebelmember";
    side = "civ";
    uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_IG_Guerilla1_1", "", 5000, {"", "", -1} },
	...
	class bandit {
	 ...
	 class secret_clothing {
        title = "Secret Clothing";
        conditions = "";
        side = "civ";
        uniforms[] = {
            { "NONE",                     "Remove Uniform", 0,    { "", "", -1 } },
            { "U_I_C_Soldier_Bandit_1_F", "",               1250, { "", "", -1 } },
            { "U_I_C_Soldier_Bandit_2_F", "",               1250, { "", "", -1 } },
            { "U_I_C_Soldier_Bandit_3_F", "",               1250, { "", "", -1 } },
            { "U_I_C_Soldier_Bandit_4_F", "",               1250, { "", "", -1 } },
            { "U_I_C_Soldier_Bandit_5_F", "",               1250, { "", "", -1 } },
            { "U_B_CTRG_Soldier_urb_3_F", "",               7500, { "", "", -1 } },
			{ "U_O_CombatUniform_ocamo", "",               75000, { "", "", -1 } },
			{ "U_O_OfficerUniform_ocamo", "",               7500, { "", "", -1 } },
			{ "U_I_C_Soldier_Para_1_F", "", 2500, {"", "", -1} },
			{ "U_I_C_Soldier_Para_2_F", "", 2500, {"", "", -1} },
			{ "U_I_C_Soldier_Para_3_F", "", 2500, {"", "", -1} },
			{ "U_I_G_resistanceLeader_F", "", 15000, {"", "", -1} },
			{ "U_I_G_Story_Protagonist_F", "", 15000, {"", "", -1} },			
			{ "U_I_C_Soldier_Para_4_F", "", 2500, {"", "", -1} },
