...
/* Database Related Settings */
    ...
    saved_virtualItems[] = {  "sugar","sugarcane","blastingcharge","coconut","cocaine_processed","cocaine_unprocessed","marijuana",
	 "cannabis", "heroin_processed","heroin_unprocessed","rock", "cement","diamond_cut","diamond_uncut","glass","salt_refined",
	 "salt_unrefined","iron_refined","iron_unrefined","oil_unprocessed","copper_unrefined","copper_refined","pickaxe","zipties",
	 "crowbar", "blindfold","sand","salt","oil_processed","fuelEmpty","fuelFull","spikeStrip","lockpick","defuseKit","storageSmall",
	 "storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel",
	 "tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","banana","bottledWhiskey",
	 "bottledBeer","bootledShine", "uranium_refined","counterfitCash","codeCracker","gateopener","busticket","cloth","leather", "straps","sjacket","cprKit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    service_chopper = 7000; //Cost to service chopper at chopper service station(Repair/Refuel).
    ...
    restricted_uniforms[] = { "U_Rangemaster", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform","U_B_survival_uniform", "U_B_Protagonist_VR", "U_B_CTRG_1", "U_B_CTRG_3", "U_B_CTRG_2","V_PlateCarrier1_tna_F" };
    restricted_weapons[] = { "optic_AMS", "optic_AMS_snd", "optic_KHS_old" };
    ...
    sendtoJail_locations[] = { "police_hq_1", "sendtojail_1", "sendtojail_2", "sendtojail_3", "sendtojail_4", "sendtojail_5", "police_hq_2", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility", "Kavala_hq","Paros_hq" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    seize_uniform[] = { "U_Rangemaster", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn" }; //Any specific uniforms you want to be seized from players
    seize_vest[] = { "V_TacVest_blk_POLICE","V_TacVest_khk","V_TacVestIR_blk","V_PlateCarrier1_tna_F","V_PlateCarrierL_CTRG","V_TacVest_oli","V_TacVest_blk","V_TacVest_khk","V_TacVest_camo","V_PlateCarrier1_blk","V_I_G_resistanceLeader_F" }; //Any specific vests you want to be seized from players
    seize_headgear[] = { "H_Cap_police","H_HelmetB_plain_mcamo","H_HelmetB_TI_tna_F","H_CrewHelmetHeli_B" }; //Any hats or helmets you want seized from players
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "O_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
    ...
    vehicle_purchase_multiplier_OPFOR = .05; // -- NOT IN USE -- Simply left in for east support.
    ...
    vehicle_rental_multiplier_OPFOR = .50; // -- NOT IN USE -- Simply left in for east support.
    ...
    crimes[] = {
        {"STR_Crime_187V","40000","187V"},
        {"STR_Crime_187","40000","187"},
        {"STR_Crime_901","25000","901"},
        {"STR_Crime_215","2000","215"},
        {"STR_Crime_213","5000","213"},
        {"STR_Crime_211","4000","211"},
        ...
        {"STR_Crime_482","150000","482"},
        {"STR_Crime_483","250000","483"},
        {"STR_Crime_459","16500","459"},
        {"STR_Crime_666","10000","666"},
        {"STR_Crime_667","45000","667"},
        {"STR_Crime_668","10000","668"}, 
        {"STR_Crime_1","10000","1"},
        {"STR_Crime_2","5000","2"},
        {"STR_Crime_3","2500","3"},
        {"STR_Crime_4","5000","4"},
        ...
        {"STR_Crime_26","20000","26"},
        {"STR_Crime_27","8000","27"}
    };
};
